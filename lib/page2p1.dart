    ...
    return Scaffold(
      ...
      body: FlutterMap(
        ...
        options: const MapOptions(
          initialCenter: LatLng(34.703866,135.494921),//(34.6696, 135.4610),
          initialZoom: 16.0,
        ),
        children: [
          //背景地図読み込み (Maptiler)
          ...
          CircleLayer(
            circles: [
              // サークルマーカー1設定
              CircleMarker(
                color: const Color.fromARGB(255, 243, 4, 4).withOpacity(0.9),
                radius: 5,
                //borderColor:
              ...
              CircleMarker(
                color: const Color.fromARGB(255, 3, 19, 248).withOpacity(0.9),
                radius: 4,
                borderColor:
